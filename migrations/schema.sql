...
CREATE TABLE IF NOT EXISTS users (
    ...
    email VARCHAR(200),
    phone VARCHAR(20),
    telegram_chat_id VARCHAR(50) NULL COMMENT 'Telegram Chat ID สำหรับส่งแจ้งเตือนเมื่อซ่อมเสร็จ',
    avatar VARCHAR(500),
...
CREATE TABLE IF NOT EXISTS repair_requests (
    ...
    user_id INT DEFAULT NULL COMMENT 'FK ไป users — ใช้ส่งแจ้งเตือน (อีเมล/Telegram/WebSocket)',
