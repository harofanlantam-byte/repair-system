...
--
-- Current Database: `repair_system`
--

/*!40000 DROP DATABASE IF EXISTS `repair_system`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `repair_system` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
INSERT INTO `audit_logs` VALUES (1,1,'admin','login','User admin (admin) logged in','::1','2026-07-16 02:33:43'),(2,1,'admin','login','User admin (admin) logged in','::1','2026-07-16 03:01:08'),(3,1,'admin','login','User admin (admin) logged in','::1','2026-07-16 03:31:55'),(4,1,'admin','login','User admin (admin) logged in','::1','2026-07-16 05:01:23'),(5,1,'admin','login','User admin (admin) logged in','::1','2026-07-16 05:23:06'),(6,1,'admin','login','User admin (admin) logged in','::1','2026-07-16 05:43:22'),(7,1,'admin','login','User admin (admin) logged in','::1','2026-07-16 05:55:51'),(8,3,'user','login','User user (user) logged in','::1','2026-07-16 05:56:22'),(9,3,'user','login','User user (user) logged in','::1','2026-07-16 06:04:50'),(10,3,'user','login','User user (user) logged in','::1','2026-07-16 06:15:56'),(11,3,'user','login','User user (user) logged in','::1','2026-07-16 06:45:51'),(12,3,'user','login','User user (user) logged in','::1','2026-07-16 06:55:26'),(13,3,'user','login','User user (user) logged in','::1','2026-07-16 08:22:38'),(14,3,'user','login','User user (user) logged in','::1','2026-07-16 08:24:56'),(15,1,'admin','login','User admin (admin) logged in','::1','2026-07-16 08:38:52'),(16,1,'admin','update_equipment','Updated equipment id=9','::1','2026-07-16 08:39:03'),(17,3,'user','login','User user (user) logged in','::1','2026-07-17 02:21:26'),(18,3,'พนักงานทั่วไป','create_repair','Created repair REP-20260717-4352','::1','2026-07-17 03:19:22'),(19,1,'admin','login','User admin (admin) logged in','::1','2026-07-17 03:19:37'),(20,1,'admin','login','User admin (admin) logged in','::1','2026-07-17 03:20:18'),(21,1,'admin','status_change_completed','Repair REP-20260717-4352: pending → completed','::1','2026-07-17 03:20:32'),(22,3,'user','login','User user (user) logged in','::1','2026-07-17 03:22:21'),(23,3,'พนักงานทั่วไป','create_repair','Created repair REP-20260717-3039','::1','2026-07-17 03:22:36'),(24,1,'admin','login','User admin (admin) logged in','::1','2026-07-17 03:22:54'),(25,1,'admin','status_change_completed','Repair REP-20260717-3039: pending → completed','::1','2026-07-17 03:23:05'),(26,1,'admin','status_change_completed','Repair REP-20260717-3039: completed → completed','::1','2026-07-17 03:23:10'),(27,1,'admin','status_change_completed','Repair REP-20260717-3039: completed → completed','::1','2026-07-17 03:23:11'),(28,1,'admin','status_change_completed','Repair REP-20260717-3039: completed → completed','::1','2026-07-17 03:23:18'),(29,1,'admin','status_change_completed','Repair REP-20260717-3039: completed → completed','::1','2026-07-17 03:23:19'),(30,1,'admin','status_change_completed','Repair REP-20260717-3039: completed → completed','::1','2026-07-17 03:23:20'),(31,3,'user','login','User user (user) logged in','::1','2026-07-17 03:30:22'),(32,3,'พนักงานทั่วไป','create_repair','Created repair REP-20260717-1515','::1','2026-07-17 03:30:44'),(33,1,'admin','login','User admin (admin) logged in','::1','2026-07-17 03:30:52'),(34,1,'admin','status_change_completed','Repair REP-20260717-1515: pending → completed','::1','2026-07-17 03:31:01');
...
INSERT INTO `notifications` VALUES (1,3,'ซ่อมสำเร็จ! ครุภัณฑ์ของคุณพร้อมรับคืน','คำแจ้งซ่อม REP-20260717-1515 — Router TP-Link TL-ER7206 ซ่อมเสร็จแล้ว กรุณาติดต่อรับคืนที่งานพัสดุ','success','repair',16,0,'2026-07-17 03:31:01');
...
INSERT INTO `repair_requests` VALUES (8,'REP-20260713-6357',15,NULL,'ทดสอบระบบ','พนักงานทั่วไป',3,'อาคารผู้ป่วยนอก','ฝ่ายการเงิน','B01','normal',NULL,'pending',NULL,'2026-07-13 06:45:28','2026-07-13 08:48:11',NULL,NULL,NULL,NULL,NULL,NULL),(9,'REP-20260713-2026',32,NULL,'ทดสอบระบบ','พนักงานทั่วไป',3,'อาคาร A','งานซ่อมบำรุง','105','normal',NULL,'pending',NULL,'2026-07-13 06:48:14','2026-07-13 08:48:11',NULL,NULL,NULL,NULL,NULL,NULL),(10,'REP-20260713-4275',37,NULL,'ทดสอบระบบ','พนักงานทั่วไป',3,'อาคาร D','ฝ่ายไอที','101','normal',NULL,'pending',NULL,'2026-07-13 06:48:26','2026-07-13 08:48:11',NULL,NULL,NULL,NULL,NULL,NULL),(11,'REP-20260713-2580',18,NULL,'ทดสอบระบบ','พนักงานทั่วไป',3,'อาคาร D','สำนักงานกลาง','B02','normal',NULL,'pending',NULL,'2026-07-13 06:48:41','2026-07-13 08:48:11',NULL,NULL,NULL,NULL,NULL,NULL),(12,'REP-20260713-4697',29,NULL,'ทดสอบระบบ','พนักงานทั่วไป',3,'อาคารอำนวยการ','ฝ่ายรังสี','401','normal',NULL,'completed',NULL,'2026-07-13 06:49:38','2026-07-13 08:48:11','2026-07-13 08:43:07',NULL,NULL,NULL,NULL,NULL),(13,'REP-20260713-9216',10,NULL,'ทดสอบระบบ','พนักงานทั่วไป',3,'อาคารผู้ป่วยนอก','ฝ่ายเภสัช','302','normal',NULL,'completed',NULL,'2026-07-13 06:50:14','2026-07-13 08:53:22','2026-07-13 08:53:22',NULL,NULL,NULL,NULL,NULL),(14,'REP-20260717-4352',9,NULL,'ทดสอบระบบ','พนักงานทั่วไป',3,'อาคาร C','ฝ่ายไอที','102','normal',NULL,'completed',NULL,'2026-07-17 03:19:22','2026-07-17 03:20:32','2026-07-17 03:20:32',NULL,NULL,NULL,NULL,NULL),(15,'REP-20260717-3039',32,NULL,'ทดสอบระบบ','พนักงานทั่วไป',3,'อาคาร A','งานซ่อมบำรุง','105','normal',NULL,'completed',NULL,'2026-07-17 03:22:36','2026-07-17 03:23:20','2026-07-17 03:23:20',NULL,NULL,NULL,NULL,NULL),(16,'REP-20260717-1515',36,NULL,'ทดสอบระบบ','พนักงานทั่วไป',3,'อาคาร A','งานซ่อมบำรุง','301','normal',NULL,'completed',NULL,'2026-07-17 03:30:44','2026-07-17 03:31:01','2026-07-17 03:31:01',NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `status_history` VALUES (9,8,NULL,'pending',NULL,'สร้างคำแจ้งซ่อมใหม่','2026-07-13 06:45:28'),(10,9,NULL,'pending',NULL,'สร้างคำแจ้งซ่อมใหม่','2026-07-13 06:48:14'),(11,10,NULL,'pending',NULL,'สร้างคำแจ้งซ่อมใหม่','2026-07-13 06:48:26'),(12,11,NULL,'pending',NULL,'สร้างคำแจ้งซ่อมใหม่','2026-07-13 06:48:41'),(13,12,NULL,'pending',NULL,'สร้างคำแจ้งซ่อมใหม่','2026-07-13 06:49:38'),(14,13,NULL,'pending',NULL,'สร้างคำแจ้งซ่อมใหม่','2026-07-13 06:50:14'),(15,13,'pending','pending',1,NULL,'2026-07-13 07:52:47'),(16,13,'pending','completed',1,NULL,'2026-07-13 07:53:13'),(17,12,'pending','completed',1,NULL,'2026-07-13 08:43:07'),(18,13,'completed','completed',1,NULL,'2026-07-13 08:51:16'),(19,13,'completed','completed',1,NULL,'2026-07-13 08:53:22'),(20,14,NULL,'pending',NULL,'สร้างคำแจ้งซ่อมใหม่','2026-07-17 03:19:22'),(21,14,'pending','completed',1,NULL,'2026-07-17 03:20:32'),(22,15,NULL,'pending',NULL,'สร้างคำแจ้งซ่อมใหม่','2026-07-17 03:22:36'),(23,15,'pending','completed',1,NULL,'2026-07-17 03:23:05'),(24,15,'completed','completed',1,NULL,'2026-07-17 03:23:10'),(25,15,'completed','completed',1,NULL,'2026-07-17 03:23:11'),(26,15,'completed','completed',1,NULL,'2026-07-17 03:23:18'),(27,15,'completed','completed',1,NULL,'2026-07-17 03:23:19'),(28,15,'completed','completed',1,NULL,'2026-07-17 03:23:20'),(29,16,NULL,'pending',NULL,'สร้างคำแจ้งซ่อมใหม่','2026-07-17 03:30:44'),(30,16,'pending','completed',1,NULL,'2026-07-17 03:31:01');
...
-- Dump completed on 2026-07-17 10:37:29
